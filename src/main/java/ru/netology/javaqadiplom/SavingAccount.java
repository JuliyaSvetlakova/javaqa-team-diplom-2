...
public class SavingAccount extends Account {
    ...
    public SavingAccount(int initialBalance, int minBalance, int maxBalance, int rate) {
        ...
        if (maxBalance < minBalance) {
            throw new IllegalArgumentException(
                    "Максимальный баланс не может быть меньше минимального: " + maxBalance + " меньше " + minBalance
            );
        }
        if (initialBalance < minBalance) {
            throw new IllegalArgumentException(
                    "Начальный баланс не может быть меньше минимального баланса: " + initialBalance + " меньше " + minBalance
            );
        }
        if (initialBalance > maxBalance) {
            throw new IllegalArgumentException(
                    "Начальный баланс не может быть больше максимального баланса: " + initialBalance + " больше " + maxBalance
            );
        }
